...
from event_registrations.serializers import TeamEventRegistrationSerializer, SoloEventRegistrationSerializer
...
class PaytmCallbackView(APIView):
    ...
    def post(self, request):
        ...
        context = {
            'ORDERID': str(transaction.order_id),
            'TXNID': transaction.transaction_id,
            'message': paytm_params['RESPMSG'],
